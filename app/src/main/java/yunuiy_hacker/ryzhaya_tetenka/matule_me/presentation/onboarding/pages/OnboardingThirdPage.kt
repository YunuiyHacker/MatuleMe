        ...
        Box(modifier = modifier.fillMaxWidth()) {
            Column(modifier = Modifier.fillMaxWidth()) {
                ...
                Image(
                    modifier = Modifier
                        .size(77.dp)
                        .offset(x = 52.dp),
                    painter = painterResource(R.drawable.onboarding_3_highlight_group),
            ...
            Column(modifier = Modifier.fillMaxWidth()) {
                ...
                Image(
                    ...
                    painter = painterResource(R.drawable.onboarding_3_img),
                    contentDescription = null,
                    contentScale = ContentScale.Crop
                ...
                Text(
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(horizontal = 30.dp),
                    text = stringResource(R.string.make_this_peace_today_little_lot_better),
                    fontFamily = poppins,
